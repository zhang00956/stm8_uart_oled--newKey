...
//void GBZK_GPIO_Config(void)//demo板
//{		
//
...
{
  transfer_command_lcd(0x8d);//OLED_WR_Byte(0X8D,OLED_CMD);  //SET DCDC命令
...
{ 
    transfer_command_lcd(0xb0+(7-y/8));
    transfer_command_lcd(((x&0xf0)>>4)|0x10);
...
//	else OLED_GRAM[x][pos]&=~temp;	
     ...
     //设置显示位置—列高地址   
//	transfer_data_lcd(OLED_GRAM[x][pos]); 
...
//		for (j = 0; j < 8; j ++) {
//			if (chTemp & 0x80) {
//				OLED_DrawPoint(chXpos, chYpos, 1);
//    		}
//			chTemp <<= 1;
//			chYpos ++;
